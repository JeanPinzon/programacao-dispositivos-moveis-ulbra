...
Esta é a **branch de partida**: um projeto Android limpo, sem nenhum conteúdo das aulas. Ela serve de ponto de entrada e de guia (este texto).
...
| `main` | Ponto de partida | Projeto Android limpo + este guia |
